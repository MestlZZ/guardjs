...
var guardIs = __webpack_require__(1);
var guardThrowIf = __webpack_require__(2);
...
var GuardIs = function () {
    function GuardIs() {
        _classCallCheck(this, GuardIs);
    }

    _createClass(GuardIs, [{
        key: 'undefined',
        get: function get() {
            return createCheck(this, function (item) {
        ...
        get: function get() {
            ...
            return createCheck(that, function (item) {
...
function createCheck(that, funcExpr) {
    var func = createFunc(that, funcExpr);

    Object.defineProperty(func, 'or', { get: function get() {
            createSalt(that, func, 'or');

            return that;
        } });

    Object.defineProperty(func, 'and', { get: function get() {
...
function createFunc(that, expression) {
    return function (item) {
        ...
        if (that._salt) {
            var type = that._salt.type;
            var check = that._salt.check;
...
var GuardThrowIf = function () {
    function GuardThrowIf() {
        _classCallCheck(this, GuardThrowIf);
    }

    _createClass(GuardThrowIf, [{
        key: 'undefined',
        get: function get() {
            var that = this;
